...
import { ArrowLeft, Calendar, Clock, Facebook, Twitter, Instagram, ChevronRight, ArrowRight } from "lucide-react"
    ...
    return (
      <div className="min-h-screen bg-stone-50 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-3xl font-light text-stone-800 mb-4">Article Not Found</h1>
          <Link href="/journal">
